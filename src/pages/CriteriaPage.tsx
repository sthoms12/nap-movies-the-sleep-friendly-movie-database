          ...
          <section className="space-y-12">
            <div className="border border-border bg-card/50 p-6 md:p-8 space-y-6">
              ...
              <div className="space-y-4 text-sm leading-relaxed text-retro-text/80">
                ...
                <p>
                  Every movie starts with a "virtual" baseline of 15 votes at an 80% nap approval rating. This
                  results in a stable initial Nap Index of <span className="text-retro-accent">~82%</span> based on our seed data.
                  As community signatures are recorded, the score gravitates toward the collective consensus.
                </p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="border border-border p-6 space-y-4">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  We value "flat" audio profiles. Sudden explosions or high-frequency transitions disrupt the
              ...
              <div className="border border-border p-6 space-y-4">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Tension is the enemy of sleep. The archive favors "Familiar" films where the narrative arc
              ...
              <div className="border border-border p-6 space-y-4">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Rain, snow, deep space, and low-light cinematography provide a cocoon-like viewing experience.
                  Films set in harsh daylight or high-energy environments are penalised by the index.
                </p>
              </div>
            </div>
            <footer className="pt-8 border-t border-border opacity-40 text-[10px] uppercase text-center tracking-[0.2em]">
              End of Document // Secure Archive Node 04 // Final Revision
            </footer>
          </section>
        </div>
      </main>
